...
{
    public static void Single(Nodes graph)
    {
    ...
    private static void Pair(Rule house, Nodes graph)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static void Triple(Rule house, Nodes graph)
    {
        var assignments = graph.Assignments(house.Cells);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static void Quad(Rule house, Nodes graph)
    {
        var assignments = graph.Assignments(house.Cells);
