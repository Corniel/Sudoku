...
{
    public static void XWing(Nodes graph)
    {
    ...
    private static void XWing(Row r1, Row r2, Col c1, Col c2, Nodes graph)
    {
    ...
    public static void Swordfish(Nodes graph)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static void Swordfish(Row r1, Row r2, Row r3, Col c1, Col c2, Col c3, Nodes graph)
    {
        var a = r1.Cells & c1.Cells;
        var b = r1.Cells & c2.Cells;
