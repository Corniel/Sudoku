...
public sealed class Arrow(ImmutableArray<Pos> cells) : Constraint
{
    ...
    public sealed class Circle(Pos circle, ImmutableArray<Pos> shaft) : Restriction
    {
        public Pos AppliesTo { get; } = circle;

        public ImmutableArray<Pos> Others { get; } = shaft;
    ...
    public sealed class Shaft(Pos sum, Pos appliesTo, ImmutableArray<Pos> others) : Restriction
    {
