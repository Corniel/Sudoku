...
{
    public static Cells Solve(Puzzle puzzle, TestSolverType solver = TestSolverType.StrategyBased)
        => Solve(puzzle.Clues, puzzle.Constraints, solver);

    public static Cells Solve(Clues clues, Rules? rules = null, TestSolverType solver = TestSolverType.StrategyBased) => solver switch
    {
