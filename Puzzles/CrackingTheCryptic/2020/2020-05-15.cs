...
public sealed class _2020_05_15 : CtcPuzzle
{
    ...
    // 9's ar officially not given but are deducted as follows:
    // All evens sum to 180
    // All odds sum to 225
    // De difference is 45 and has to be put in 5 cells.
    // Without it th 9s filled in, it takes a minute instead.
    ...
    public sealed class Cage(Pos appliesTo, ImmutableArray<Pos> others) : Group(appliesTo, others), Peers
    {
        ...
        private static readonly Ints Zero = Ints.New(60);
    }
}
