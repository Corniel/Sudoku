...
public sealed class GermanWhisper(ImmutableArray<Pos> cells) : Rule(cells)
{
    ...
    private sealed class Toggle(Pos appliesTo, Pos neighbor) : Pair(appliesTo, neighbor)
    {
        ...
        public override Digits Restrict(Digits other) => Allowed[other];

        private static readonly DigitLookup<Digits> Allowed = Init([
            /* ? */ [1, 2, 3, 4, 6, 7, 8, 9],
            /* 1 */ [6, 7, 8, 9],
            /* 2 */ [6, 7, 8, 9],
            /* 3 */ [6, 7, 8, 9],
